...
### Task 1: Ввести публичные дизайн-токены и примитивы
...
### Task 2: Заменить публичный shell, навигацию и футер
...
### Task 3: Добавить read API связанного контента и коммерческие view models
...
### Task 4: Перестроить главную страницу
...
### Task 5: Создать каталог и единый шаблон услуг
...
### Task 6: Создать каталог и структурированный шаблон кейсов
...
### Task 7: Выровнять редакционные и юридические страницы, зафиксировать старые URL
...
### Task 8: Реализовать версионированное согласие на аналитику
...
### Task 9: Подключить consent-gated аналитику и события
...
### Task 10: Добавить браузерные проверки адаптивности, доступности и движения
...
### Task 11: Провести полную регрессию и подготовить локальный релизный срез
