...
Установите Node.js LTS. На Windows откройте PowerShell и выполните:

```powershell
winget install --id OpenJS.NodeJS.LTS -e
```

После установки закройте и заново откройте PowerShell, затем проверьте версию:
...
Если используется `nvm`, можно поставить Node.js так:
