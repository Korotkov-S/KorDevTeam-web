...
import { Form, useLoaderData, useMatches } from "react-router";
...
export default function AdminSeoRoute() {
  const data = useLoaderData<SeoAdminLoaderData>();
  ...
  return <AdminSeoDashboard data={data} csrfToken={csrfToken} />;
}
