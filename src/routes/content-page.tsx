...
export async function loader({ request, params }: LoaderFunctionArgs) {
  ...
  return data({ seo: entrySeo(entry, pathname, media), title: String(entry.payload.h1 || entry.title), bodyMd: entry.bodyMd, excerpt: entry.excerpt, media }, { headers: documentHeaders });
}
