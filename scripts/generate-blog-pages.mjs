...
function buildRedirects(slugs, projects) {
  ...
  lines.push("/project/Media%20%26%20Entertainment    /cases/noodome/    301!");
  lines.push("/project/Media%20&%20Entertainment    /cases/noodome/    301!");
  lines.push("/project/media-entertainment    /cases/noodome/    301!");
  lines.push("/project/web-site    /cases/alliance-stroy-garant/    301!");
  lines.push("/project/web-service    /cases/sims-dynasty-tree/    301!");
  lines.push("/project/harmonize-me    /cases/harmonize-me/    301!");
  lines.push("/project/stroyrem    /cases/stroyrem/    301!");
