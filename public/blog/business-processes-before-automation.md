...
> Ты выступаешь как бизнес-аналитик. Ниже дана расшифровка реального процесса. Не додумывай отсутствующие факты. Сначала выдели начало и конечный результат процесса, участников и используемые системы. Затем составь таблицу AS IS: шаг, роль, вход, действие, результат, система, срок ожидания и исключение. Отдельно перечисли противоречия, пропущенные данные и вопросы, которые нужно задать сотрудникам. После этого подготовь черновик BPMN по дорожкам: события, задачи, шлюзы, сообщения и конечные состояния.
